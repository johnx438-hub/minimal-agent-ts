...
const ToolFallbackImpl: ToolCallMessagePartComponent = ({
  ...
  const [prevPrefer, setPrevPrefer] = useState(preferOpen);
  if (preferOpen !== prevPrefer) {
    setPrevPrefer(preferOpen);
    // Open when entering generating/latest; do not force-close if user opened manually
