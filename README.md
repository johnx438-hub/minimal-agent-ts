...
| `cli-web-search` | 基于 EXA MCP 的搜索引擎 | EXA |
| `wormhole` | 端到端加密文件传输，生成临时分享链接（<5GB） | [magic-wormhole](https://github.com/magic-wormhole/magic-wormhole) |

> 🙏 感谢上述开源项目及其维护者，没有他们这些 skill 不会存在。
